...
public final class Constants {
	...
	public final static int USER_NOT_FOUND_CODE = 1001;
	public final static String USER_NOT_FOUND_MSG = "User Not Found";
	
	public final static int USER_EXIST_CODE = 1002;
	public final static String USER_EXIST_MSG = "User Already Exist";
	
	public final static int SUCCESS_CODE = 1003;
	public final static String SUCCESS_MSG = "Success";
	
	public final static int FAILED_CODE = 1004;
	public final static String FAILED_MSG = "Failed";
	
	public final static int INVALID_CREDENTIALS_CODE = 1005;
